...
const Notifications = () => {
  ...
  return (
    <Popover>
      <PopoverTrigger className='relative flex size-10 items-centre justify-center rounded-lg'>
        <Image src='/assets/icons/bell.svg' alt='inbox' width={24} height={24} />
        {count > 0 && <div className='absolute right-2 top-2 size-2 rounded-full bg-blue-500' />}
      </PopoverTrigger>
